        ...
        <div className="lg:pt-13 relative flex flex-col h-full max-h-full">
                <nav className="hs-accordion-group p-3 w-full flex flex-col flex-wrap" data-hs-accordion-always-open="true">
                    <ul className="flex flex-col space-y-1">
                        ...
                        <li className={`hs-accordion ${route().current('admin.product.*') ? 'active' : ''}`} id="account-accordion">
                            <button type="button" className={`hs-accordion-toggle ${route().current('admin.product.*') ? 'bg-gray-200 ' : ''}w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 text-[15px] text-gray-800 rounded-lg hs-accordion-active:rounded-b-none hover:bg-gray-100 focus:outline-hidden focus:bg-gray-200 dark:bg-neutral-800 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 dark:text-neutral-200" aria-expanded="true" aria-controls="account-accordion-child`}>
                            ...
                            <div id="account-accordion-child" className={`${route().current('admin.product.*') ? 'block' : 'hidden'} hs-accordion-content bg-gray-200 w-full overflow-hidden transition-[height] duration-300 hidden" role="region" aria-labelledby="account-accordion`}>
                        ...
                        <li className={`hs-accordion ${route().current('admin.warranty.*') ? 'active' : ''}`} id="account-accordion">
                            <button type="button" className={`hs-accordion-toggle ${route().current('admin.warranty.*') ? 'bg-gray-200 ' : ''}w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 text-[15px] text-gray-800 rounded-lg hs-accordion-active:rounded-b-none hover:bg-gray-100 focus:outline-hidden focus:bg-gray-200 dark:bg-neutral-800 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 dark:text-neutral-200" aria-expanded="true" aria-controls="account-accordion-child`}>
                                <IoHomeSharp className={`size-4.5`} />
                                Warranty
                            ...
                            <div id="account-accordion-child" className={`${route().current('admin.warranty.*') ? 'block' : 'hidden'} hs-accordion-content bg-gray-200 w-full overflow-hidden transition-[height] duration-300 hidden" role="region" aria-labelledby="account-accordion`}>
                                <ul className="p-1.5 space-y-1">
                                    <li>
                                        <Link href={route('admin.warranty.list')} className={`flex items-center gap-x-2.5 pr-2.5 py-1 text-[15px] text-gray-800 rounded-lg ${route().current('admin.warranty.list') ? 'bg-gray-50' : ''} hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:bg-neutral-800 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 dark:text-neutral-200`}>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12 15a3 3 0 1 1 0-6a3 3 0 0 1 0 6Z"/></svg>
                                            Warranty List
                                        </Link>
                                    </li>

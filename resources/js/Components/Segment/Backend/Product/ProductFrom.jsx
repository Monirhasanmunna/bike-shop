...
export default function BlogForm({product, setProduct}){
    ...
    const handleSubmitForm = (e) => {
        ...
        if(!product){
            post(route('admin.product.store'), {
                preserveState: true,
                preserveScroll: true,
                onError: () => HSOverlay.open('#product-form'),
                onSuccess: () => {
                    HSOverlay.close('#product-form')
                    reset()
                    setProduct(null)
                    setPreviewImage(null)
                }
    ...
    return (
        <div id="product-form"
             ...
             role="dialog" tabIndex="-1" aria-labelledby="product-form-label">
            <div
                ...
                <div
                    ...
                    <div
                        ...
                        <h3 id="product-form-label" className="font-bold text-gray-800 text-md dark:text-white">
                            {product ? 'Update': 'Create'} Form
                        </h3>
                        <button type="button"
                                onClick={(e) => {
                                    reset()
                                ...
                                aria-label="Close" data-hs-overlay="#product-form">
                        ...
                        <form onSubmit={handleSubmitForm}  className={`w-full space-y-2`}>
                            ...
                            <div className="form-control pt-4">
                                <div className="w-full flex gap-x-4">
                                    <Button buttonText={!product ? 'Create' : 'Update'} isLoading={processing} />
                                    <Button
                                        buttonText={'Cancel'}
                                        type={`button`}
                                        callback={() => HSOverlay.close("#product-form")}
